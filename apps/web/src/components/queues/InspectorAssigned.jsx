...
const InspectorAssigned = ({ onGoToInspection, onGoBack }) => {
    ...
    useEffect(() => {
        const interval = setInterval(() => setSecondsSinceAssignment(prev => prev + 1), 1000);
        return () => clearInterval(interval);
    }, []);

    // Mostrar notificación y color según el tiempo
    useEffect(() => {
        if (secondsSinceAssignment === warningTime) {
            ...
            setNotification('Por inactividad de 10 minutos se cierra la inspección. Si desea continuar con el proceso, por favor seleccione nuevamente el enlace enviado anteriormente para retomar la conexión.');
            setNotificationColor('text-red-600');
        } else {
            setNotification(''); // quitar notificación mientras no corresponda
    ...
    // Color del temporizador según tiempo
                ...
                <Card className="shadow-lg">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="bg-green-50 border border-green-200 p-6 rounded-lg text-center">
                            ...
                            {/* Botón solo si no se acabó el tiempo */}
